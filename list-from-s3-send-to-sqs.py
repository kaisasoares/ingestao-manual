...
bucket = 'grupon-solution-sprint3'
#urlSQS = 'https://sqs.us-east-1.amazonaws.com/873816429411/grupon-queue-csv-to-json'
#keyprefix = 'files-small/'
urlSQS = 'https://sqs.us-east-1.amazonaws.com/873816429411/grupon-json-to-firehose'
keyprefix = 'json/'
